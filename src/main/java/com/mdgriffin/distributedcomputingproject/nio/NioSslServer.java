...
public class NioSslServer extends NioSslPeer {
    ...
    /**
     * SocketServer is designed to apply an SSL/TLS protocol and listen to an IP address and port.
     *
    ...
    public NioSslServer(String protocol, String hostAddress, int port) throws Exception {
        ...
        context.init(createKeyManagers("./src/main/resources/ssl/server.jks", "storepass", "keypass"), createTrustManagers("./src/main/resources/ssl/trustedCerts.jks", "storepass"), new SecureRandom());
